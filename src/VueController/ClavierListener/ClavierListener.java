...
public class ClavierListener implements KeyListener {
     ...
     */
    private final ArrayList<ListenerRaccourciFabrique> listenersLegume = new ArrayList<>();
    ...
    public ClavierListener(){
        ...
        Fabrique.getInstances().forEach(fabrique -> {
            try {
                listenersLegume.add(new ListenerRaccourciFabrique(KeyEvent.class.getDeclaredField("VK_"+fabrique.getRaccourci()),fabrique));
